...
/* appearance */
static const unsigned int refresh_rate = 30;    /* Matches dwm's mouse event processing to your monitor's refresh rate for smoother window interactions. */
...
static const char *gamingcmd[]  = { "flatpak", "run", "net.lutris.Lutris", NULL };
